  ...
  <div class="barra-pestanas">
    <div class="contenedor">
      <ul class="nav nav-tabs px-3">
        <li class="nav-item">
          <a class="nav-link active" href="login/login.php">Inicio</a>
        </li>
        <li class="nav-item">
    ...
    <div class="blog-container">
      ...
      <div class="blog-text">
        <p class="blog">
          ...
          – Identificación, Análisis y Prevención, es una regulación que busca proteger la salud mental y el bienestar de los trabajadores en México. Establece la obligación de los centros de trabajo de identificar,
          analizar y prevenir factores de riesgo psicosocial como el estrés laboral,
          la violencia organizacional y las condiciones desfavorables en el entorno de trabajo.
          <br><br>
