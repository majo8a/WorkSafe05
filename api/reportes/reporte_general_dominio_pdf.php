...
SELECT 
    ...
    r.nivel_riesgo
FROM Resultado r
GROUP BY r.dominio, r.nivel_riesgo
ORDER BY r.dominio
";
...
$pdf->Cell(0,10,utf8_decode('REPORTE GENERAL POR DOMINIO - NOM-035'),0,1,'C');
...
"El presente reporte muestra los resultados generales obtenidos por dominio de riesgo psicosocial, conforme a los criterios establecidos en la Norma Oficial Mexicana NOM-035-STPS-2018."
));
$pdf->Ln(5);
...
$pdf->Cell(100,7,'Dominio',1,0,'C',true);
...
foreach ($dominios as $dom => $d) {
    $pdf->Cell(100,7,utf8_decode($dom),1);
...
/* DESCARGA DIRECTA */
$pdf->Output('D','Reporte_General_Dominios_NOM035.pdf');
